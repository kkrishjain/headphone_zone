...
(function (Flits) {
    ...
    var AccountPage = (Flits.AccountPage = function (options) {
        ...
        function wishlistModuleFunc() {
            if (wishlistAjaxCall && wishlistTemplateCall) {
                var settings = { data: wishlistRespData };
        ...
        (settings = Flits.extend(Flits.AccountPage.settings, settings, options)), Flits.dispatchEvent("Flits:AccountPage:Loaded", { settings: settings }), Flits.setPhoneCountryCode();
        var hash = window.location.hash;
        hash.length ? Flits.navigationFunc(hash) : Flits.navigationFunc(Flits.AccountPage.settings.active_tab, 0),
        ...
        last_customer != undefined &&
            ...
            Flits(document).on("Flits:orderTemplate:Loaded", function (event) {
                ...
                Flits(".flits-account-page-tabs .flits-tabs-box #flits_tab_order").find(".flits-order-module-loader").remove(),
                    ...
                    Flits.order(),
                    Flits.Metafields.IS_ORDER_CONTACT_US_ENABLE == 1 && Flits.contactUS();
            });
        let topOrderRespData = null;
        let topOrderAjaxCall = !1;
        let topOrderTemplateCall = !1;
        Flits(document).on("Flits:topOrderTemplate:Loaded", function (event) {
            ...
            Flits(".flits-account-page-tabs .flits-tabs-box #flits_tab_topOrder").find(".flits-module-loader").remove(),
                ...
                (topOrderTemplateCall = !0),
                topOrderModuleFunc();
        });
        let wishlistRespData = null;
        let wishlistAjaxCall = !1;
        let wishlistTemplateCall = !1;
        Flits(document).on("Flits:wishlistTemplate:Loaded", function (event) {
            ...
            Flits(".flits-account-page-tabs .flits-tabs-box #flits_tab_wishlist").find(".flits-module-loader").remove(),
                ...
                (wishlistTemplateCall = !0),
                wishlistModuleFunc();
        });
        let storeCreditRespData = null;
        let storeCreditAjaxCall = !1;
        let storeCreditTemplateCall = !1;
        Flits(document).on("Flits:storeCreditTemplate:Loaded", function (event) {
            ...
            Flits(".flits-account-page-tabs .flits-tabs-box #flits_tab_storeCredit").find(".flits-module-loader").remove(),
                ...
                (storeCreditTemplateCall = !0),
                storeCreditModuleFunc();
        });
        let rulesRespData = null;
        let rulesAjaxCall = !1;
        let rulesTemplateCall = !1;
        ...
        Flits(document).on("Flits:referFriendTemplate:Loaded", function (event) {
            ...
            Flits(document).on("Flits:customer:AjaxSuccessful", function (event) {
                let resp = event.detail.resp;
                if (resp.status)
                    Flits.Metafields.IS_STORE_CREDIT_PAID == 1 && Flits.Metafields.is_store_credit_enable == 1
                        ? (Flits.services.settings.rulesService(function (resp) {
                              (rulesRespData = resp), (rulesAjaxCall = !0), rulesModuleFunc();
                          }),
                          Flits.services.settings.storeCreditService(function (resp) {
                              (storeCreditRespData = resp), (storeCreditAjaxCall = !0), storeCreditModuleFunc();
                          }),
                          Flits.services.settings.referCreditService(function (resp) {
                              (referRespData = resp), (referAjaxCall = !0), referFriendModuleFunc();
                          }),
                          Flits.Metafields.IS_REFER_PROGRAM_ON == 1
                              ? Flits.get(
                          ...
                          Flits.get(
                              ...
                              function (resp) {
                                  Flits.dispatchEvent("Flits:storeCreditTemplate:Loaded", { resp: resp }),
                                      Flits.Metafields.IS_HOW_TO_EARN_CREDIT_DISPLAY == 1 ? Flits.dispatchEvent("Flits:rulesTemplate:Loaded", { resp: resp }) : Flits("#flits_tab_howToManageCredit").remove();
                              },
                              "html"
                          ))
                        : (Flits("#flits_tab_storeCredit").remove(), Flits("#flits_tab_howToManageCredit").remove(), Flits("#flits_tab_referFriend").remove());
                else {
            ...
            Flits.get(
                ...
                function (resp) {
                    Flits.dispatchEvent("Flits:profileTemplate:Loaded", { resp: resp }),
                        Flits.Metafields.is_recently_view_enable == 1
                            ? Flits.dispatchEvent("Flits:recentlyViewTemplate:Loaded", { resp: resp })
                            : (Flits("#flits_tab_recentlyView").remove(), Flits("#flits_mobile_tab_recentlyView").remove()),
            ...
            Flits.Metafields.IS_ADVANCE_DASHBOARD_PAID == 1 && Flits.Metafields.IS_ADVANCE_DASHBOARD_ENABLE == 1
                ? (Flits.services.settings.topOrderService(function (resp) {
                      (topOrderRespData = resp), (topOrderAjaxCall = !0), topOrderModuleFunc();
                  }),
                  Flits.get(
            ...
            Flits.Metafields.IS_WISHLIST_PAID == 1 && Flits.Metafields.IS_WISHLIST_ENABLE == 1
                ? (Flits.services.settings.wishlistService(function (resp) {
                      (wishlistRespData = resp), (wishlistAjaxCall = !0), wishlistModuleFunc();
                  }),
                  Flits.get(
            ...
            Flits(document).on("click", ".flits-nav-tabs .flits-menu-item", function (e) {
                if (!Flits(this).hasClass("flits-external-link")) {
                    ...
                    target_attr.search("#") != 0 || Flits.navigationFunc(target_attr);
                }
            }),
            Flits(document).on("click", ".flits-back-btn", function () {
                Flits(".flits-account-page-container").toggleClass("flits-active"), (location.hash = "");
            }),
            ...
            Flits(document).on("click", ".flits-pagination-div .flits-pagination-btn", function () {
                ...
                let position = Flits('.flits-pagination-div[data-flits-pagination="' + paginationOf + '"] .flits-pagination li').index(
                    Flits('.flits-pagination-div[data-flits-pagination="' + paginationOf + '"] .flits-pagination li.active')
                );
                let liList = Flits('.flits-pagination-div[data-flits-pagination="' + paginationOf + '"] .flits-pagination li');
                btnAttr == "flits-prev-btn" ? Flits(liList[position - 1]).trigger("click") : Flits(liList[position + 1]).trigger("click");
            }),
            Flits(document).on("click", ".flits-add-to-cart", function () {
                ...
                (Flits(el).attr("data-flits-add-action-from") == "wishlist" || Flits(el).attr("data-flits-add-action-from") == "recentlyView") &&
                    Flits(el).parents(".flits-product-card").find(".flits-variant-select").val() == "" &&
                    (id = Flits(el).parents(".flits-product-card").find(".flits-variant-select option:nth-child(2)").val());
                let interval = 0;
                cartOrder[id] &&
                    quantity + parseInt(cartOrder[id].cart_quantity) > maxLimit &&
                    ((quantity = maxLimit - parseInt(cartOrder[id].cart_quantity)),
                    quantity == 0 ? (quantity = maxLimit) : quantity,
                    (interval = 3000),
                    flitsSnackbar.show({ text: Flits.t("Flits.locals.general.cart_updated", "Some items are no longer available. Your cart has been updated."), pos: "bottom-center", showAction: !1, customClass: "flits-alert-default" }));
            ...
            Flits(document).on("keypress", '.flits-product-quantity input[name="product_quantity_input"]', function (event) {
                return Flits.phoneNumberBind(this), Flits.isNumber(event);
            }),
            Flits(document).on("input", '.flits-product-quantity input[name="product_quantity_input"]', function (event) {
                (/^0/.test(this.value) || /^\s*$/.test(this.value)) && ((this.value = this.value.replace(/^0/, "1")), (this.value = this.value.replace(/^\s*$/, "1")));
            }),
    ...
    var myProfile = (Flits.myProfile = function (options) {
        function phoneWithContry() {
            ...
            else if (((Flits.shopCountryName = Flits.shopCountryName.replace("&amp;", "&")), Flits('.flits-profile-phone-with-country-div .flits-country-drpdown select option[data-country-name="' + Flits.shopCountryName + '"]')))
        ...
        function profileNonEditForm() {
            Flits(".flits-profile-edit-button").show(),
                ...
                Flits("#flits-form-profile .flits-input").attr("readonly", !0),
                Flits('#flits-form-profile .flits-input[name="email"]').attr("readonly", !0),
                Flits('#flits-form-profile .flits-input[name="birthdate"]').attr("type", "text"),
                Flits('#flits-form-profile .flits-input[name="birthdate"]').val() || Flits('#flits-form-profile .flits-input[name="birthdate"]').val(""),
                Flits('#flits-form-profile .flits-inputl[name="referby"]').attr("readonly", !0),
                Flits("#flits-form-profile select.flits-input").attr("disabled", !0),
        ...
        var settings = { phoneValid: !0, emailValid: !0, phoneNumber: "" };
        ...
        (newDate = newDateYY + "-" + newDateMM + "-" + newDateDD),
            ...
            Flits(document).on("click", ".flits-profile-edit-button", function () {
                Flits(this).hide(),
                    ...
                    Flits("#flits-form-profile .flits-input").attr("readonly", !1),
                    Flits('#flits-form-profile .flits-input[name="email"]').attr("readonly", !0),
                    Flits('#flits-form-profile .flits-input[name="birthdate"]').attr("type", "date"),
                    Flits('#flits-form-profile .flits-input[name="referby"]').attr("readonly", !0),
                    Flits("#flits-form-profile select.flits-input").attr("disabled", !1),
            ...
            Flits(document).on("click", ".flits-profile-cancel-button", function () {
                Flits("#flits-form-profile")[0].reset(), profileNonEditForm(), Flits(".flits-profile-phone-with-country-div .flits-country-drpdown select").trigger("change");
            }),
            Flits(".flits-profile-save-button").on("click", function () {
                ...
                Flits.validateEmail(emailValue)
                    ? (Flits.myProfile.settings.emailValid = !0)
                    : ((Flits.myProfile.settings.emailValid = !1),
                      flitsSnackbar.show({ text: Flits.t("Flits.locals.profile_page.invalid_email", "Email is not valid"), pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" })),
                    (Flits.myProfile.settings.phoneValid = !0),
                    phoneValue.length > 0 &&
                        !Flits.validatePhone(phoneNumber) &&
                        ((Flits.myProfile.settings.phoneValid = !1),
                        flitsSnackbar.show({ text: Flits.t("Flits.locals.profile_page.invalid_contact_number", "Contact number is not valid"), pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" })),
                    Flits.myProfile.settings.phoneValid && Flits.myProfile.settings.emailValid && Flits("#flits-form-profile").submit();
            }),
            Flits("#flits-form-profile").submit(function (event) {
                ...
                params[indexGender].value == "none" && params.splice(indexGender, 1);
                ...
                number.length != 0 && (params[index].value = country + number);
                let url = Flits.base_url + "/" + Flits.customer_id + form.attr("action");
                let method = form.attr("method");
                params.push({ name: "customer_hash", value: Flits.customerHash},{name: "token", value: Flits.token }),
                    flitsSnackbar.show({ text: Flits.t("Flits.locals.profile_page.save_details", "Saving profile details..."), pos: "bottom-center", showAction: !1, customClass: "flits-alert-default" }),
                            ...
                            if (resp.status) {
                                (Flits.myProfile.settings.phoneNumber = resp.customer.phone),
                                    Flits("#flits-form-profile input").each(function (i, v) {
                                        ...
                                        Flits(v).attr("value", inputVal), Flits(v).val(inputVal);
                                    }),
                                ...
                                resp.customer.gender == null ? (genderVal = "none") : (genderVal = resp.customer.gender),
                                    ...
                                    flitsSnackbar.show({ text: Flits.t("Flits.locals.profile_page.saved_successfully", "Profile updated successfully"), pos: "bottom-center", showAction: !1, customClass: "flits-alert-success" });
                            } else {
                                let errors = JSON.parse(resp.response).errors;
                                let error_key = Object.keys(errors)[0];
                                let error_text = errors[Object.keys(errors)[0]][0];
                                (error_text = getProfileErrorMsg(error_key + " " + error_text)), flitsSnackbar.show({ text: error_text, pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" });
                            }
                        })
                        .fail(function (resp) {
                            flitsSnackbar.show({ text: Flits.t("Flits.locals.general.something_went_wrong", "Something went wrong. Please try again."), pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" });
                        })
                        .always(function () {});
            });
    });
    var deliveryAddress = (Flits.deliveryAddress = function (options) {
        function addressAppend(addressDesk, page) {
            ...
            for (i = 0; i < addressDesk.length; i++)
                if (!Flits(addressDesk[i]).hasClass("flits-default-hidden-card")) {
                    ...
                    (newItem._values.id = newItem.elm.dataset.id), Flits.deliveryAddress.settings.addressList.items.splice(index + i, 0, newItem), Flits.deliveryAddress.settings.addressList.update();
                }
            setAddressData();
        }
        function getAddress(page) {
            ...
            Flits.ajax({ url: url, method: "GET", data: { page: page } })
                .done(function (res) {
                    ...
                    if (addressRows.length) addressAppend(addressRows, page);
                    else return Flits.dispatchEvent("Flits:deliveryAddress:AllLoaded"), !1;
                })
                .fail(function (resp) {})
                .always(function () {});
        }
        function setAddressData() {
            Flits(".flits-address-list-pagination-row").removeClass("flits-d-none"), Flits(".flits-address-pagination-loader").hide();
        }
        ...
        function shopifySetup() {
            Flits && Flits.CountryProvinceSelector && new Flits.CountryProvinceSelector("AddressCountryNew", "AddressProvinceNew", { hideElement: "AddressProvinceContainerNew" });
        }
        function phoneWithContry() {
            let numberDetails;
            let countryIndex;
            let onlyNumber;
            let areaCode;
            let mobileNumber = form.find('.flits-input[name="address[phone]"]').val();
            if(mobileNumber)
            if (form.find('.flits-input[name="address[phone]"]').val())
                // While craeting instance of libphonenumber we are specifying second argument as a country code "IN" beacuse this only has indian customers
                (numberDetails = new libphonenumber.parsePhoneNumber(form.find('.flits-input[name="address[phone]"]').val(),"IN")),
            ...
            else if (((Flits.shopCountryName = Flits.shopCountryName.replace("&amp;", "&")), Flits('.flits-address-phone-with-country-div .flits-country-drpdown select option[data-country-name="' + Flits.shopCountryName + '"]')))
        ...
        function addressForm(item) {
            form.find("#AddressFirstNameNew").val(item.attr("data-first-name")),
                ...
                form.find("#address_default_address_new").attr("checked", item.attr("data-default") == "true" ? !0 : !1),
        ...
        function isPhoneValid() {
            ...
            countryValue = countryValue ? countryValue : '+91'; 
            let phoneNumber = countryValue + phoneValue;
            phoneValue.length > 0
                ? Flits.validatePhone(phoneNumber)
                    ? form.submit()
                    : (Flits(".flits-address-card .flits-address-card-action").removeClass("flits-disabled"),
                      flitsSnackbar.show({ text: Flits.t("Flits.locals.address_page.invalid_contact_number", "Contact number is not valid"), pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" }))
                : form.submit();
        }
        ...
        if (
            ...
            Flits.deliveryAddress.settings.totalAddress == 0 ? Flits(".flits-address-pagination-loader").hide() : Flits.deliveryAddress.settings.totalAddress >= 2 && Flits(".flits-address-list-pagination-row").addClass("flits-hr"),
            setPagination(),
            Flits.deliveryAddress.settings.totaPages >= 1)
        )
            for (i = 1; i <= Flits.deliveryAddress.settings.totaPages; i++) getAddress(i);
        ...
        shopifySetup(),
                ...
                params.push({ name: "customer_hash", value: Flits.customerHash},{name: "token", value: Flits.token }),
                    formType == "edit"
                        ? ((method = "PUT"),
                          ...
                          flitsSnackbar.show({ text: Flits.t("Flits.locals.address_page.updating_address", "Updating Address..."), pos: "bottom-center", showAction: !1, customClass: "flits-alert-default", duration: !1 }))
                        : (Flits.dispatchEvent("Flits:deliveryAddress:BeforeAdd", { params: params }),
                          flitsSnackbar.show({ text: Flits.t("Flits.locals.address_page.adding_new_address", "Adding New Address..."), pos: "bottom-center", showAction: !1, customClass: "flits-alert-default", duration: !1 })),
                    Flits.ajax({ method: method, url: url, data: params })
                        .done(function (resp) {
                            if (resp.status) {
                                ...
                                if (
                                    ...
                                    formType == "edit"
                                        ...
                                        : ((Flits.deliveryAddress.settings.totalAddress = parseInt(Flits.deliveryAddress.settings.totalAddress) + 1),
                                          Flits(".flits-address-count-badge").html(Flits.deliveryAddress.settings.totalAddress),
                                          Flits.deliveryAddress.settings.totalAddress >= 2 ? Flits(".flits-address-list-pagination-row").addClass("flits-hr") : Flits(".flits-address-list-pagination-row").removeClass("flits-hr")),
                                    ...
                                    Flits.deliveryAddress.settings.totalAddress > 1 && Flits(".flits-address-list-pagination-row").removeClass("flits-d-none"),
                                    adrs.default)
                                )
                                    if (formType == "edit") {
                                        let addressStaticList = Flits(".flits-address-list-static-row");
                                        let oldDefaultItem = Flits(addressStaticList).find(".flits-address-card.flits-address-default").removeClass("flits-address-default").attr("data-default", !1);
                                        ...
                                        (newItem._values.id = newItem.elm.dataset.id),
                                            ...
                                            Flits(itemClone).addClass("flits-address-default").attr("data-default", !0),
                                        ...
                                        if (Flits.deliveryAddress.settings.totalAddress > 1) {
                                            let oldDefaultItem = Flits(addressStaticList).find(".flits-address-card.flits-address-default").removeClass("flits-address-default").attr("data-default", !1);
                                            var newItem = new Flits.deliveryAddress.settings.addressList.Item(["id"], oldDefaultItem[0]);
                                            (newItem._values.id = newItem.elm.dataset.id), Flits.deliveryAddress.settings.addressList.items.push(newItem), Flits.deliveryAddress.settings.addressList.update();
                                        }
                                        Flits(itemClone).addClass("flits-address-default"), Flits(addressStaticList).append(itemClone.clone()), Flits(addressStaticList).find(".flits-address-card[data-default='false']").remove();
                                    }
                                else if (formType == "edit") Flits.deliveryAddress.settings.addressList.update();
                                else {
                                ...
                                formType == "edit"
                                    ...
                                    : (Flits.dispatchEvent("Flits:deliveryAddress:Added", { resp: resp }),
                                      flitsSnackbar.show({
                                          text: Flits.t("Flits.locals.address_page.address_added_successfully", "Delivery address added successfully"),
                                          pos: "bottom-center",
                                          showAction: !1,
                                          customClass: "flits-alert-success",
                                      })),
                                ...
                                let error_key = Object.keys(errors)[0];
                                let error_text = errors[Object.keys(errors)[0]][0];
                                (error_text = getAddressErrorMsg(error_key + " " + error_text)), flitsSnackbar.show({ text: error_text, pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" });
                            }
                            Flits(".flits-address-card .flits-address-card-action").removeClass("flits-disabled");
                        })
                        .fail(function (resp) {
                            Flits(".flits-address-card .flits-address-card-action").removeClass("flits-disabled"), flitsSnackbar.show({ text: resp.statusText, pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" });
                        })
                        .always(function () {});
            }),
            Flits(document).on("click", ".flits-new-address", function (event) {
                form.find("#address_default_address_new").parent().show(),
                    form.find("#address_default_address_new").attr("checked", !1),
                ...
                countryVal.indexOf("---") == 0 && form.find("#AddressCountryNew").val(Flits(countryName).val()), shopifySetup(), phoneWithContry();
            }),
            Flits(document).on("click", ".flits-address-cancel-btn", function () {
                form[0].reset(), Flits(".flits-address-display-container").removeClass("flits-d-none"), Flits(".flits-address-form").addClass("flits-d-none");
            }),
            ...
            Flits(document).on("click", ".flits-address-remove-btn", function () {
                ...
                if (
                    ...
                    confirm(confirmMessage || Flits.t("Flits.locals.address_page.delete_confirmation_message", "Are you sure you want to delete this address?")))
                ) {
                    let url = "/account/addresses/" + formId;
                    (url = Flits.base_url + "/" + Flits.customer_id + url),
                        flitsSnackbar.show({ text: Flits.t("Flits.locals.address_page.deleting_address", "Deleting Address..."), pos: "bottom-center", showAction: !1, customClass: "flits-alert-default" }),
                        Flits.ajax({ method: "DELETE", url: url, data: { customer_hash: Flits.customerHash, token:Flits.token, _mehtod: "DELETE" } })
                            .done(function (resp) {
                                if (resp.status) {
                                    ...
                                    Flits(".flits-address-list-pagination-row .flits-address-card").not(".flits-default-hidden-card").length == 0 &&
                                        ((Flits.deliveryAddress.settings.addressList.i = showItem), Flits(".flits-address-pagination .flits-prev-btn").trigger("click")),
                                        Flits.deliveryAddress.settings.addressList.update(),
                                        Flits.deliveryAddress.settings.totalAddress >= 2 ? Flits(".flits-address-list-pagination-row").addClass("flits-hr") : Flits(".flits-address-list-pagination-row").removeClass("flits-hr"),
                                        Flits.dispatchEvent("Flits:deliveryAddress:Removed", { resp: resp });
                                } else flitsSnackbar.show({ text: resp.error, pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" });
                                Flits(".flits-address-card .flits-address-card-action").removeClass("flits-disabled");
                            })
                            .fail(function (resp) {
                                Flits(".flits-address-card .flits-address-card-action").removeClass("flits-disabled"), flitsSnackbar.show({ text: resp.statusText, pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" });
                            ...
                            .always(function () {});
                } else Flits(".flits-address-card .flits-address-card-action").removeClass("flits-disabled");
            }),
            Flits(document).on("click", ".flits-address-default-btn", function () {
                debugger;
                Flits(".flits-address-card .flits-address-card-action").addClass("flits-disabled");
                let item = Flits(this).parents(".flits-address-card");
                item.attr("data-default", "true"), addressForm(item), isPhoneValid();
            }),
    ...
    var order = (Flits.order = function (options) {
        function setOrdersSearch() {
            Flits(".flits-order-list-container").removeClass("flits-d-none"), Flits(".flits-order-loader").hide(), Flits(".flits-order-loader").remove();
        }
        function setPagination() {
        ...
        function ordersAppend(ordersDesk, page) {
            Flits(".flits-orders-temp .flits-orders").html(ordersDesk), Flits.dispatchEvent("Flits:order:contactUs");
            ...
            for (i = 0; i < orderRowsDesk.length; i++) {
                ...
                Flits(newItem.elm).find('.cancelBtn').removeClass("loading");
                // START : Cancle Button Code
                var newItemOrderCreated = Flits(newItem.elm).find('.flits-order-action-row').attr('data-flits-order-created');
                var newItemOrderId = Flits(newItem.elm).find('.flits-order-action-row').attr('data-flits-order-id');
                var startDate = new Date(newItemOrderCreated);
                var endDate   = new Date();
                var h = Math.floor(((endDate.getTime() - startDate.getTime()) / 1000)/ 3600);
              	Flits(newItem.elm).find('.flits-order-action-row').attr("data-h",h);
                if(h < 1) {
                  
                  // Disable cancel Button // attr("disabled",true)
                  Flits(newItem.elm).find('.cancelBtn[data_id='+newItemOrderId+']').removeAttr("data-target").hide();
                  Flits(newItem.elm).find('.dummy__button[data_id='+newItemOrderId+']').show();
                }
                else{
                  Flits(newItem.elm).find('.dummy__button[data_id='+newItemOrderId+']').hide();
                }
                // END
                Flits.order.settings.orderList.items.splice(index + i, 1), Flits.order.settings.orderList.items.splice(index + i, 0, newItem);
              	
            }
            Flits.order.settings.orderList.items.length >= showItem && isShowItem
                ? ((isShowItem = !1), (Flits.order.settings.orderList.i = showItem), Flits.order.settings.orderList.update())
                : isShowItem || Flits.order.settings.orderList.update();
        }
        function getOrderAjax(page, check) {
            ...
            Flits.ajax({ url: url, method: "GET", data: { page: page } })
                .done(function (res) {
                    ...
                    if (orderRows.length) ordersAppend(orderRows, page), check && (page++, extraOrder(page));
                    else
                        return (
        ...
        (settings = Flits.extend(Flits.order.settings, settings, options)), Flits.dispatchEvent("Flits:order:Loaded", { settings: settings });
        var showItem = 1;
        var isShowItem = !0;
        if (
            ...
            Flits.order.settings.totalOrder == 0 && Flits.order.settings.orderSize > 0 && (Flits.order.settings.totalOrder = Flits.order.settings.orderSize),
            ...
            for (
                skeletonOrderCount = Flits.order.settings.totalOrder, totalOrderCount != undefined && (skeletonOrderCount = Flits.order.settings.totalOrder > totalOrderCount ? Flits.order.settings.totalOrder : totalOrderCount), i = 0;
                i < skeletonOrderCount;
                i++
            ) {
                let skeletonDom = Flits(".flits-skeleton-order-template").clone();
                Flits(skeletonDom).removeClass("flits-skeleton-order-template"), Flits(".flits-order-div .flits-order-list").append(skeletonDom), i == skeletonOrderCount - 1 && Flits(".flits-skeleton-order-template").remove();
            }
            (showItem = (pageNo - 1) * Flits.order.settings.perPageLimit + 1),
                setPagination(),
                setOrdersSearch(),
                getOrderAjax(pageNo, !1),
                pageNo > Flits.order.settings.totaPages ? (getOrders(1, pageNo - 1), extraOrder(pageNo + 1)) : (getOrders(1, Flits.order.settings.totaPages), extraOrder(Flits.order.settings.totaPages + 1));
        } else Flits(".flits-order-empty").removeClass("flits-d-none"), Flits(".flits-order-loader").hide(), Flits(".flits-order-loader").remove();
        Flits(".flits-order-div .flits-pagination").bind("click", function (event) {
            Flits.setLocalStorage("order_page_no", parseInt(Flits(event.target).text())), Flits.dispatchEvent("Flits:order:pageClick", { pageNo: parseInt(Flits(event.target).text()) }), Flits.dispatchEvent("Flits:order:contactUs");
        }),
            Flits(document).on("click", ".flits-order-details-btn", function () {
                ...
                Flits(this).parents(".flits-order-card").find(".flits-order-details-summary").is(":visible") ? buttin_s.text(show_text) : buttin_s.text(hide_text),
            ...
            Flits(document).on("click", ".flits-reorder-btn", function () {
                ...
                if (((params.items = []), items.length > 0)) {
                        ...
                        item.item_variant_id
                            ? item.available == "true"
                                ? (parseInt(item.inventory_quantity) <= parseInt(item.quantity)
                                      ? cartOrder[item.variant_id] &&
                                        (parseInt(item.inventory_quantity) > parseInt(cartOrder[item.variant_id].cart_quantity)
                                      ...
                                      : cartOrder[item.variant_id] &&
                                        parseInt(item.inventory_quantity) <= parseInt(cartOrder[item.variant_id].cart_quantity) + parseInt(item.quantity) &&
                                        ((item.quantity = parseInt(item.inventory_quantity) - parseInt(cartOrder[item.variant_id].cart_quantity)),
                                        flitsSnackbar.show({
                                            text: Flits.t("Flits.locals.general.cart_updated", "Some items are no longer available. Your cart has been updated."),
                                            pos: "bottom-center",
                    ...
                    noItem == 1
                        ? flitsSnackbar.show({ text: Flits.t("Flits.locals.order_page.one_product_unavailable", "One of the products is unavailable"), pos: "bottom-center", showAction: !1, customClass: "flits-alert-default" })
                        : noItem > 1 &&
                          flitsSnackbar.show({ text: Flits.t("Flits.locals.order_page.some_products_unavailable", "Some of the products are unavailable"), pos: "bottom-center", showAction: !1, customClass: "flits-alert-default" }),
                        soldOutItem == 1
                            ? setTimeout(
                                  function () {
                                      flitsSnackbar.show({ text: Flits.t("Flits.locals.order_page.one_product_sold_out", "One of the products is sold out."), pos: "bottom-center", showAction: !1, customClass: "flits-alert-default" });
                                  },
                                  noItem > 0 ? 1500 : 0
                              )
                            : soldOutItem > 1 &&
                              setTimeout(
                                  function () {
                                      flitsSnackbar.show({ text: Flits.t("Flits.locals.order_page.some_products_sold_out", "Some of the products are sold out"), pos: "bottom-center", showAction: !1, customClass: "flits-alert-default" });
                                  },
                                  noItem > 0 ? 1500 : 0
                              ),
    ...
    var contactUS = (Flits.contactUS = function (options) {
            ...
            keyup == 0
                ? statusVal.length == 0
                    ? (Flits(selector).addClass(Flits.contactUS.settings.errorSelector),
                      ...
                      (Flits.contactUS.settings.emailValid = !1))
                    : Flits.validateEmail(statusVal)
                    ? (Flits(selector).removeClass(Flits.contactUS.settings.errorSelector), Flits(alertSelector).html(""), (Flits.contactUS.settings.emailValid = !0))
                    : (Flits(selector).addClass(Flits.contactUS.settings.errorSelector), Flits(alertSelector).html(Flits.contactUS.settings.invalidEmailWarning), (Flits.contactUS.settings.emailValid = !1))
                : (Flits(selector).removeClass(Flits.contactUS.settings.errorSelector), Flits(alertSelector).html(""));
        }
        function phoneValidationCheck(keyup) {
            ...
            keyup == 0
                ? statusVal.length > 0
                    ? Flits.validatePhone(phoneNumber)
                        ? (Flits(selector).removeClass(Flits.contactUS.settings.errorSelector), Flits(alertSelector).html(alertSelector).html(""), (Flits.contactUS.settings.phoneValid = !0))
                        : (Flits(selector).addClass(Flits.contactUS.settings.errorSelector),
                          Flits(alertSelector).html(Flits.contactUS.settings.alertIcon + Flits.contactUS.settings.invalidPhoneNumberWarning),
                          (Flits.contactUS.settings.phoneValid = !1))
                    : (Flits(selector).removeClass(Flits.contactUS.settings.errorSelector), Flits(alertSelector).html(alertSelector).html(""), (Flits.contactUS.settings.phoneValid = !0))
                : (Flits(selector).removeClass(Flits.contactUS.settings.errorSelector), Flits(alertSelector).html(alertSelector).html(""));
        }
        function reasonValidationCheck() {
            ...
            statusVal == null
                ? (Flits(selector).addClass(Flits.contactUS.settings.errorSelector),
                  ...
                  (Flits.contactUS.settings.reasonValid = !1))
                : (Flits(selector).removeClass(Flits.contactUS.settings.errorSelector), Flits(alertSelector).html(alertSelector).html(""), (Flits.contactUS.settings.reasonValid = !0));
        }
        function messageValidationCheck(keyup) {
            ...
            let statusVal = Flits(selector).val();
            keyup == 0
                ? statusVal.trim().length == 0
                    ? (Flits(selector).addClass(Flits.contactUS.settings.errorSelector),
                      Flits(alertSelector).html(Flits.contactUS.settings.alertIcon + Flits.contactUS.settings.messageRequiredWarning),
                      (Flits.contactUS.settings.messageValid = !1))
                    : (Flits(selector).removeClass(Flits.contactUS.settings.errorSelector), Flits(alertSelector).html(alertSelector).html(""), (Flits.contactUS.settings.messageValid = !0))
                : (Flits(selector).removeClass(Flits.contactUS.settings.errorSelector), Flits(alertSelector).html(alertSelector).html(""));
        }
        function urlValidationCheck(keyup) {
            ...
            keyup == 0
                ? statusVal.length > 0
                    ? Flits.validateUrl(statusVal)
                        ? (Flits(selector).removeClass(Flits.contactUS.settings.errorSelector), Flits(alertSelector).html(alertSelector).html(""), (Flits.contactUS.settings.urlValid = !0))
                        : (Flits(selector).addClass(Flits.contactUS.settings.errorSelector),
                          Flits(alertSelector).html(Flits.contactUS.settings.alertIcon + Flits.contactUS.settings.invalidAttachmentLinkWarning),
                          (Flits.contactUS.settings.urlValid = !1))
                    : (Flits(selector).removeClass(Flits.contactUS.settings.errorSelector), Flits(alertSelector).html(alertSelector).html(""), (Flits.contactUS.settings.urlValid = !0))
                : (Flits(selector).removeClass(Flits.contactUS.settings.errorSelector), Flits(alertSelector).html(alertSelector).html(""));
        }
        function updateContactUs() {
            Flits.getLocalStorage(Flits.contactUS.settings.contactUsHandle) == null || Flits.getLocalStorage(Flits.contactUS.settings.contactUsHandle) == undefined
                ? (Flits.setLocalStorage(Flits.contactUS.settings.contactUsHandle, []), (Flits.contactUS.settings.queue = Flits.getLocalStorage(Flits.contactUS.settings.contactUsHandle)))
        ...
        function contactFormSubmit() {
            if (
                ...
                Flits.contactUS.settings.emailValid == 1 && Flits.contactUS.settings.reasonValid == 1 && Flits.contactUS.settings.messageValid == 1 && Flits.contactUS.settings.phoneValid == 1 && Flits.contactUS.settings.urlValid == 1)
            ) {
                formValueSet();
                ...
                index != -1 ? (Flits.contactUS.settings.queue[index].contacted_at = _contactedAt) : Flits.contactUS.settings.queue.push({ order_number: _orderNumber, contacted_at: _contactedAt }),
        ...
        function contactFormReset() {
            Flits("#" + Flits.contactUS.settings.formId)[0].reset(), Flits("#" + Flits.contactUS.settings.flitsFormId)[0].reset();
            ...
            Flits.each(allClasses, function (id, el) {
                Flits(el).removeClass("flits-input-success"), Flits(el).removeClass("flits-input-error");
            }),
        ...
        function formValueSet() {
            ...
            _customerName.trim().length == 0
                ? Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-name").attr("disabled", !0)
                : (Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-name").removeAttr("disabled"), Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-name").val(_customerName.trim())),
                _customerEmail.length == 0
                    ? Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-email").attr("disabled", !0)
                    : (Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-email").removeAttr("disabled"), Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-email").val(_customerEmail)),
                _customerMobile.length == 0
                    ? Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-phone").attr("disabled", !0)
                    : (Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-phone").removeAttr("disabled"), Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-phone").val(_customerPhoneNo)),
                _customerMessage.trim().length == 0
                    ? Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-message").attr("disabled", !0)
                    : (Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-message").removeAttr("disabled"), Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-message").val(_customerMessage)),
                _customerReason.trim().length == 0
                    ? Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-reason").attr("disabled", !0)
                    : (Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-reason").removeAttr("disabled"), Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-reason").val(_customerReason)),
                _customerAttachLink.length == 0
                    ? Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-url").attr("disabled", !0)
                    : (Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-url").removeAttr("disabled"), Flits("#" + Flits.contactUS.settings.flitsFormId + "-customer-url").val(_customerAttachLink)),
        ...
        function phoneWithContry() {
            ...
            else if (((Flits.shopCountryName = Flits.shopCountryName.replace("&amp;", "&")), Flits('.flits-contact-us-phone-number-country-div select option[data-country-name="' + Flits.shopCountryName + '"]')))
                (countryIndex = Flits('.flits-contact-us-phone-number-country-div select option[data-country-name="' + Flits.shopCountryName + '"]').val()), Flits(".flits-contact-us-phone-number-country-div select").val(countryIndex);
            else {
                let defualtCountry = Flits.defualtCountry;
                (countryIndex = Flits('.flits-contact-us-phone-number-country-div select option[data-country-iso-code="' + defualtCountry + '"]').val()), Flits(".flits-contact-us-phone-number-country-div select").val(countryIndex);
            }
        ...
        function contactUsDone() {
            ...
            contactUsLocal.forEach(function notifyInserFunc(item, index) {
                if (Flits.timeDiffer({ date1: item.contacted_at, date2: new Date(), type: "day" }) < Flits.contactUS.settings.noOfDay) {
                    ...
                    Flits('.flits-contact-us-btn[data-flits-order-number="' + item.order_number + '"]') &&
                        (Flits('.flits-contact-us-btn[data-flits-order-number="' + item.order_number + '"]').attr("data-flits-contact-done", !0),
        ...
        if (
            ...
            Flits(".flits-form-message").on("keyup", function (event) {
                messageOnChange(this), messageValidationCheck(1);
            }),
            ...
            Flits(document).on("click", ".flits-contact-us-btn", function (event) {
                contactFormReset(), phoneWithContry();
            ...
            Flits(document).on("click", ".flits-close-popup", function () {
                ...
                modal_Id == "flits-contact-us-form" ? Flits("#flits-contact-us-form").removeClass("active-popup") : modal_Id == "flits-contact-us-form-success" && Flits("#flits-contact-us-form-success").removeClass("active-popup");
            }),
            Flits(document).on("click", ".flits-contactus-success-btn", function () {
                Flits("body").css("overflow", "auto"), Flits("#flits-contact-us-form-success").removeClass("active-popup");
            }),
            ...
            Flits.contactUS.settings.formError == 1)
        ) {
            Flits.contactUS.settings.formError = !1;
            ...
            c && (window.history.pushState("object", document.title, newURL + "#order"), Flits.navigationFunc("#order"), Flits("#flits-contact-us-form-success").addClass("active-popup"), Flits("body").css("overflow", "hidden"));
        }
    });
    var setPhoneCountryCode = (Flits.setPhoneCountryCode = function (options) {
        ...
        (settings = Flits.extend(Flits.setPhoneCountryCode.settings, settings, options)),
            ...
            Flits(document).on("change", ".flits-profile-phone-with-country-div .flits-country-drpdown select", function (event) {
                ...
                let countryFlagImage = Flits("<img/>");
                countryFlagImage.attr("src", "https://flagcdn.com/w40/"+countryIsoCode.toLowerCase()+".png"),
                    Flits(".flits-profile-phone-with-country-div .flits-country-flag").html(countryFlagImage),
            ...
            Flits(document).on("change", ".flits-address-phone-with-country-div .flits-country-drpdown select", function (event) {
                ...
                let countryFlagImage = Flits("<img/>");
                countryFlagImage.attr("src", "https://flagcdn.com/w40/"+countryIsoCode.toLowerCase()+".png"),
                    Flits(".flits-address-phone-with-country-div .flits-country-flag").html(countryFlagImage),
            ...
            Flits(document).on("change", ".flits-contact-us-phone-number-country-div select", function (event) {
                ...
                let countryFlagImage = Flits("<img/>");
                countryFlagImage.attr("src", "https://flagcdn.com/w40/"+countryIsoCode.toLowerCase()+".png"),
                    Flits(".flits-contact-us-phone-number-country-div .flits-country-flag").html(countryFlagImage),
    ...
    var topOrder = (Flits.topOrder = function (options) {
        ...
        function viewTopProducts(data) {
            if ((Flits(".flits-top-order-div .flits-top-order-list").attr("data-flits-top-order-count", data.orders_count), data.status && data.orders_count > 0)) {
                ...
                Flits.each(products, function (index, product) {
                    ...
                    let image = "";
                    orderItemProduct.image == null ? (image = Flits.topOrder.settings.noImage) : (image = orderItemProduct.image.src);
                    let extidx = image.lastIndexOf(".");
                    let extension = image.substr(extidx);
                    (image = image.replace(extension, "_200x_crop_center" + extension)), itemClone.find(".flits-product-image img").attr("src", image);
                    ...
                    imgWidth > imgHeight,
                        ...
                        Flits.each(orderItemProduct.variants, function (var_index, variant) {
                            variant.title == "Default Title" && (itemClone.find(".flits-variant-select").parents(".flits-select-row").hide(), itemClone.find(".flits-product-quantity").addClass("w-100"));
                                        ...
                                        if (!response.variant_available) {
                                            ...
                                            if (selectedText.indexOf(Flits.t("Flits.locals.buttons.sold_out", "Sold Out")) != -1) {
                                                ...
                                                itemClone.find(".flits-add-to-cart").addClass("flits-btn-danger"),
                                                    itemClone.find(".flits-add-to-cart").attr("disabled", !0),
                                                    itemClone.find(".flits-add-to-cart").text(sold_out_text),
                                                    itemClone.find(".flits-product-quantity").addClass("flits-disabled");
                                            }
                                        }
                                        response.variant_available && response.inventory_management == "shopify" && response.inventory_quantity > 0 && optionElement.attr("data-flits-inventory-quantity", response.inventory_quantity);
                        ...
                        index == products.length - 1 && Flits.dispatchEvent("Flits:topOrder:BindSuccessful");
                });
            } else Flits(".flits-top-order-empty").removeClass("flits-d-none"), Flits(".flits-top-order-loader").hide();
        }
        function notFound() {
            Flits.topOrder.settings.topOrderList.update(), Flits(".flits-top-order-list .flits-top-order-card").length == 0 ? Flits(".flits-not-find").addClass("flits-active") : Flits(".flits-not-find").removeClass("flits-active");
        }
        ...
        (settings = Flits.extend(Flits.topOrder.settings, settings, options)),
            ...
            Flits(document).on("Flits:topOrder:BindSuccessful", function () {
                Flits(".flits-top-order-list-div").removeClass("flits-d-none"), Flits(".flits-top-order-loader").hide(), topOrderFilter();
            }),
                ...
                switch (type) {
                    ...
                    case "days":
                        ...
                        Flits.topOrder.settings.topOrderList.filter(function (item) {
                            return parseInt(item.values().days) <= days ? !0 : !1;
                        });
                        break;
                }
                notFound();
            ...
            Flits(document).on("input", ".flits-top-order-list-div .flits-search-fillter .flits-search", function (event) {
                event.target.value
                    ...
                    : (Flits(".flits-search-fillter .flits-clear-icon").addClass("flits-d-none"), (Flits.topOrder.settings.topOrderList.searched = !1), Flits.topOrder.settings.topOrderList.update()),
            ...
            Flits(document).on("click", ".flits-top-order-list-div .flits-search-fillter .flits-clear-icon", function (event) {
                Flits(".flits-top-order-list-div .flits-search-fillter .flits-search").val(""),
                    ...
                    (Flits.topOrder.settings.topOrderList.searched = !1),
    ...
    var Wishlist = (Flits.Wishlist = function (options) {
        ...
        var settings = { wishlistHandle: "flits_wishlist_products", perPageLimit: 9, wishlistList: null, data: null };
        (settings = Flits.extend(Flits.Wishlist.settings, settings, options)),
        ...
        let data = Flits.Wishlist.settings.data;
        Flits(".flits-wishlist-count-badge").html(data.count),
            Flits(".flits-wishlist-count-badge").removeClass("flits-menu-badge-hide"),
            data != null && data.count > 0 ? Flits.productDomDisplay(data, "flits-wishlist-product-list", 0) : (Flits(".flits-wishlist-empty").removeClass("flits-d-none"), Flits(".flits-wishlist-loader").hide()),
            Flits(document).on("click", ".flits-remove-product", function () {
                        ...
                        Flits.ajax({ type: "DELETE", url: Flits.base_url + "/wishlist/remove_from_wishlist", contentType: "application/x-www-form-urlencoded", data: params })
                            .done(function (resp) {
                                Flits(".flits-wishlist-count-badge").html(resp.customer_wishlist_count),
                                    resp.customer_wishlist_count == 0 && (Flits(".flits-wishlist-list-div").addClass("flits-d-none"), Flits(".flits-wishlist-empty").removeClass("flits-d-none")),
                                    ...
                                    Flits.Wishlist.settings.wishlistList && (Flits.Wishlist.settings.wishlistList.remove("flits-product-id", productId), Flits.Wishlist.settings.wishlistList.update());
                                let noOfPage = Flits(".flits-wishlist-data-div .flits-pagination li").length;
                                Flits(".flits-wishlist-product-list li").length == 0 &&
                                    Flits(removeFrom)
                ...
                let el = Flits(this);
                let removeFrom = Flits(this).parents('.flits-wishlist-list-div'); // Add it
        ...
        (settings = Flits.extend(Flits.recentlyView.settings, settings, options)),
            ...
            Flits(document).on("Flits:recentlyDataBind:Successful", function () {
                ...
                (Flits.recentlyView.settings.recentViewList = new flitsList("flits-recently-view-product-list", options).on("updated", function (list) {
                    ...
                    Flits(".flits-recently-view-product-list-div").removeClass("flits-d-none"),
                    Flits(".flits-recently-view-loader").hide();
            });
        let recentViewData = Flits.getLocalStorage(Flits.recentlyView.settings.recentHandle);
        recentViewData != null && recentViewData.length > 0
            ? Flits.productDomDisplay(recentViewData, "flits-recently-view-product-list", 1)
            : (Flits(".flits-recently-view-empty").removeClass("flits-d-none"), Flits(".flits-recently-view-loader").hide());
    });
    var storeCredit = (Flits.storeCredit = function (options) {
            ...
            switch (comment) {
                ...
                default:
                    if (comment && comment.includes("Spent in")) {
                        ...
                        let isPosComment = !1;
                        comment.indexOf("Order through POS.") != -1 && ((comment = comment.replace("Order through POS.", "")), (isPosComment = !0));
                        let splitBy = " - ";
                        if (comment.includes(splitBy)) {
                            let resultComment = comment.split(splitBy);
                            (comment = resultComment[0]), (additionalComment = splitBy + resultComment[1]);
                        }
                        (comment = comment.replace("Spent in", "")), (comment = comment.replace("Order.", ""));
                        let orderNumber = comment.trim();
                        return (
                            (comment = Flits.t("Flits.locals.credit_page.spent_in_order", "Spent in {{ order_number }} order")),
                            isPosComment && (comment = Flits.t("Flits.locals.credit_page.spent_in_order_through_pos", "Spent in {{ order_number }} order through POS").replace("{{ order_number }}", orderNumber)),
            ...
            Flits(".flits-earn-credit-value").html(Flits.formatMoney(Math.abs(customer.total_earned_credits), Flits.money_format)),
                ...
                log.length > 0
                    ? Flits.each(log, function (logIndex, logItem) {
                          ...
                          liClone.removeClass("flits-credit-log-title"), liClone.removeClass("flits-credit-log-item-template"), liClone.attr("id"), liClone.attr("id", "flits-log-" + logItem.id);
                          let credits = logItem.credits;
                          credits > 0
                              ? (liClone.find(".flits-earn-credit-icon-round").removeClass("flits-d-none"), (credits = Flits.formatMoney(Math.abs(credits), Flits.money_format)))
                              : (liClone.find(".flits-spent-credit-icon-round").removeClass("flits-d-none"), (credits = Flits.formatMoney(Math.abs(credits), Flits.money_format))),
                          ...
                          if (
                              ...
                              logItem.metafields !== void 0 && logItem.metafields.length > 0)
                          ) {
                              ...
                              Flits.each(logItem.metafields, function (subLogIndex, subLogIem) {
                                  ...
                                  credits > 0 ? (credits = Flits.formatMoney(Math.abs(credits), Flits.money_format)) : (credits = Flits.formatMoney(Math.abs(credits), Flits.money_format)),
                          ...
                          Flits(".flits-store-credit-log-list").append(liClone), log.length - 1 == logIndex && Flits.dispatchEvent("Flits:storeCredit:ListSuccessful");
                      })
        ...
        if (data.status) {
            ...
            Flits(".flits-earn-credit-value").html(Flits.formatMoney(Math.abs(0), Flits.money_format)),
                Flits(".flits-spent-credit-value").html(Flits.formatMoney(Math.abs(0), Flits.money_format)),
                Flits(".flits-current-credit-value").html(Flits.formatMoney(Math.abs(0), Flits.money_format)),
                Flits(".flits-credit-count-badge").html(Flits.formatMoney(Math.abs(0), Flits.money_format)),
                Flits(".flits-credit-count-badge").removeClass("flits-menu-badge-hide"),
                Flits(".flits-store-credit-balance").removeClass("flits-d-none"),
                Flits(".flits-history-credit-box").removeClass("flits-d-none"),
                Flits(".flits-store-credit-empty").removeClass("flits-d-none"),
    ...
    var howToEarnCredit = (Flits.howToEarnCredit = function (options) {
        function setRules(data) {
            ...
            Flits.each(rules, function (ruleIndex, ruleItem) {
                ...
                if (ruleItem.is_default_rule) {
                    (credits = ruleItem.credits), ruleItem.is_fixed || ruleItem.module_on == "monthly_date" ? (credits = Flits.formatMoney(Math.abs(credits), Flits.money_format)) : ((credits /= 100), (credits += "%"));
                    switch (ruleItem.module_on) {
                        ...
                        case "birthdate":
                            ...
                            Flits("[data-flits-birthdate]").attr("data-flits-birthdate") && ((description = birthdayDescription), ruleBoxClone.find(".flits-birthday-unlock-badge").addClass("flits-hide"));
                        ...
                        case "product_tag":
                            ...
                            Flits(ruleItem.avails).each(function (index, item) {
                                ...
                                index > 0 && productTagSpan.append(","), productTagSpan.append(productTagAnchor);
                            });
                ...
                } else (title = ruleItem.title), (description = ruleItem.description);
                if (
                    (ruleBoxClone.find(".flits-rule-details").html(title),
                    ruleItem.module_on == "birthdate" ? ruleBoxClone.find(".flits-birthday-rule-description").html(description) : ruleBoxClone.find(".flits-rule-credit").html(description),
                    ruleItem.mappedRuleIds ? ruleBoxClone.attr("data-flits-rule-id-array", ruleItem.mappedRuleIds.toString()) : ruleBoxClone.attr("data-flits-rule-id-array", ruleItem.rule_id),
                    ruleBoxClone.attr("data-flits-rule-id", ruleItem.rule_id),
                    ruleItem.is_earned && ruleBoxClone.find(".flits-rule-box").addClass("flits-earned-rule flits-z-dept-1"),
                    rulesConfig[ruleItem.module_on])
                ) {
                ...
                Flits(".flits-nav-pil-link[data-href=" + Flits.howToEarnCredit.settings.ruleTabActive + "]").length == 0
                    ? (Flits(".flits-nav-pils li:first-child a").addClass("flits-nav-pil-link-active"), Flits(".flits-tab-pane[data-id=" + Flits(".flits-nav-pils li:first-child a").attr("data-href") + "]").addClass("flits-nav-tab-active"))
        ...
        (settings = Flits.extend(Flits.howToEarnCredit.settings, settings, options)),
            ...
            Flits(document).on("Flits:howToEarnRules:Successful", function (event) {
                Flits(".flits-how-to-manage-container").removeClass("flits-d-none"), Flits(".flits-how-to-manage-empty").addClass("flits-d-none"), Flits(".flits-how-to-manage-loader").hide();
            });
        ...
        Flits(document).on("click", ".flits-nav-pil-link", function () {
            ...
            allRules.length > 0 ? setRules(allRules) : (Flits(".flits-how-to-manage-container").addClass("flits-d-none"), Flits(".flits-how-to-manage-empty").removeClass("flits-d-none"), Flits(".flits-how-to-manage-loader").hide());
    });
    var referCredit = (Flits.referCredit = function (options) {
        function updateReferCredit(resp) {
            ...
            if (customer.referral_code != "") {
                ...
                Flits('input[name="referral link"]').val(shareableLink), Flits(".flits-refer-link-container").removeClass("flits-d-none");
            }
            resp.refer_by != "" && (Flits("#flits-referby-row").removeClass("flits-d-none"), Flits("#flits-referred-by").val(resp.refer_by)),
                typeof navigator.share == "function" && Flits(".flits-navigator-button").removeClass("flits-d-none"),
                resp.facebook_share && Flits(".flits-facebook-button").removeClass("flits-d-none"),
                resp.whatsapp_share && Flits(".flits-whatsapp-button").removeClass("flits-d-none");
            let totalEarnedCredits = 0;
            log.length > 0
                ? Flits.each(log, function (logIndex, logItem) {
                      let liClone = Flits(".flits-refer-credit-log-item-template").clone();
                      liClone.removeClass("flits-credit-log-title"), liClone.removeClass("flits-refer-credit-log-item-template"), liClone.attr("id"), liClone.attr("id", "flits-log-" + logItem.id);
                      let credits = logItem.credits;
                      ...
                      let referrerEmail = "--";
                      logItem.referrer_customer != null && ((referrerName = logItem.referrer_customer.name), (referrerEmail = logItem.referrer_customer.email)),
                          ...
                          log.length - 1 == logIndex && Flits.dispatchEvent("Flits:referCredit:ListSuccessful");
                  })
        ...
        (settings = Flits.extend(Flits.referCredit.settings, settings, options)),
            ...
            Flits(document).on("click", ".flits-copy-btn", function () {
                Flits.copyClipBoardCode(this),
                    flitsSnackbar.show({ text: Flits.t("Flits.locals.refer_friend_page.referral_link_copied", "Link Copied"), pos: "bottom-center", showAction: !1, customClass: "flits-alert-default", duration: 1500 });
            }),
            Flits(document).on("click", ".flits-share-btn", function (event) {
                ...
                url && Flits.popupWindow(url, platform.charAt(0).toUpperCase() + platform.slice(1) + " Share", window, 700, 700);
            });
        let data = Flits.referCredit.settings.data;
        if (data.status) updateReferCredit(data);
        else
    ...
    var changePassword = (Flits.changePassword = function (options) {
        ...
        (settings = Flits.extend(Flits.changePassword.settings, settings, options)),
            ...
            Flits(document).on("keyup", "#flits-form-change-password input[name=password]", function () {
                ...
                inputLength >= 6 && inputLength <= 40 ? Flits("#flits-form-change-password .flits-password-hint").hide() : Flits("#flits-form-change-password .flits-password-hint").show();
            }),
            Flits("#flits-form-change-password input[name=password]").on("focus", function () {
                Flits("#flits-form-change-password .flits-password-hint").show(), Flits(".flits-password-hint").css("opacity", 1);
            }),
            Flits("#flits-form-change-password input[name=password]").on("blur", function () {
                Flits("#flits-form-change-password .flits-password-hint").hide(), Flits(".flits-password-hint").css("opacity", 0);
            }),
            Flits(document).on("keyup", "#flits-form-change-password input[name=password_confirmation]", function () {
                let inputLength = Flits(this).val().length;
                inputLength >= 6 && inputLength <= 40 ? Flits("#flits-form-change-password .flits-confirm-password-hint").hide() : Flits("#flits-form-change-password .flits-confirm-password-hint").show();
            }),
            Flits("#flits-form-change-password input[name=password_confirmation]").on("focus", function () {
                Flits("#flits-form-change-password .flits-confirm-password-hint").show(), Flits("#flits-form-change-password .flits-confirm-password-hint").css("opacity", 1);
            }),
            Flits("#flits-form-change-password input[name=password_confirmation]").on("blur", function () {
                Flits("#flits-form-change-password .flits-confirm-password-hint").hide(), Flits("#flits-form-change-password .flits-confirm-password-hint").css("opacity", 0);
            }),
            Flits(".flits-change-pass-button").on("click", function () {
                ...
                Flits("#flits-form-change-password .flits-password-hint").hide(),
                    ...
                    password.value.length == 0 || confirm_password.value.length == 0
                        ? ((formSubmit = !1),
                          flitsSnackbar.show({ text: Flits.t("Flits.locals.update_password_page.password_empty_message", "The password is empty"), pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" }))
                        : (password.value.length >= 6 && password.value.length <= 40
                              ? password.value !== confirm_password.value &&
                                ((formSubmit = !1),
                                flitsSnackbar.show({ text: Flits.t("Flits.locals.update_password_page.password_not_match", "Passwords didn't match. Try again."), pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" }))
                              : ((formSubmit = !1),
                                flitsSnackbar.show({
                                    text: Flits.t("Flits.locals.update_password_page.password_hint_message", "Password must between 6 to 40 characters."),
                                    pos: "bottom-center",
                                    showAction: !1,
                                    customClass: "flits-alert-danger",
                                })),
                          confirm_password.value.length >= 6 && confirm_password.value.length <= 40),
                    formSubmit && Flits("#flits-form-change-password").submit();
            }),
            Flits("#flits-form-change-password").submit(function (event) {
                ...
                return (
                    params.push({ name: "customer_hash", value: Flits.customerHash},{name: "token", value: Flits.token }),
                    flitsSnackbar.show({ text: Flits.t("Flits.locals.update_password_page.updating_password", "Updating password..."), pos: "bottom-center", showAction: !1, customClass: "flits-alert-default" }),
                    ...
                    Flits.ajax({ method: method, url: url, data: params })
                        ...
                        .fail(function (resp) {
                            flitsSnackbar.show({ text: resp.statusText, pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" });
                        })
                        .always(function () {}),
                    !1
                );
    ...
    Flits.extend({
        navigationFunc: function (elem, from_flag) {
            ...
            var el = elem.replace("#", "");
            (Flits('.flits-nav-tabs a[href="' + elem + '"]').length == 0 || Flits(".flits-account-page-tabs #flits_tab_" + el).length == 0) && ((elem = Flits.AccountPage.settings.active_tab), (el = elem.replace("#", ""))),
                el == "changePassword" && Flits("#flits-form-change-password")[0] && Flits("#flits-form-change-password")[0].reset(),
                Flits(window).width() < 992 && from_flag == 0
                    ? Flits(".flits-account-page-container").removeClass("flits-active")
                    : (Flits(".flits-account-page-container").addClass("flits-active"), from_flag == 1 && window.history.pushState("object", document.title, newURL + elem)),
        ...
        productDomDisplay: function (data, selector, condtion) {
            function domCloneFunction(item, index) {
                ...
                Flits(clone_dom).removeAttr("id"),
                    Flits(clone_dom).css("display", "block"),
                    Flits(clone_dom)
                    ...
                    condtion == 0
                        ...
                        : (Flits(clone_dom).find(".flits-product-card").addClass("flits-recently-view-card"), Flits(clone_dom).find(".flits-add-to-cart").attr("data-flits-add-action-from", "recentlyView")),
                ...
                let listElement = '<li data-flits-product-handle="' + item.product_handle + '" data-flits-product-id="' + item.product_id + '"></li>';
                Flits(appenSelector).append(listElement), Flits(appenSelector).find("li:last-child").append(clone_dom);
            }
            if (condtion == 0) {
                let count = data.count;
                let products = data.data;
                let status = data.status;
                status && count > 0 && products.forEach(domCloneFunction);
            } else data.length > 0 && data.forEach(domCloneFunction);
            var temp_element = Flits("." + selector + " li");
            temp_element.each(function (e, v) {
                Flits.getProductData(v), e == temp_element.length - 1 && (condtion == 1 ? Flits.dispatchEvent("Flits:recentlyDataBind:Successful") : Flits.dispatchEvent("Flits:WishlistDataBind:Successful"));
            });
        },
        getProductData: function (item) {
            function fillProductData(response) {
                ...
                product.image != null && (image = product.image.src);
                let extidx = image.lastIndexOf(".");
                let extension = image.substr(extidx);
                (image = image.replace(extension, "_200x_crop_center" + extension)), Flits(itemDom).find(".flits-product-image img").attr("src", image);
                ...
                product.variants.forEach(function (variant, variantIndex) {
                    ...
                    var optionElement = Flits("<option/>");
                    product.variants.length == 1 && variantTitle == "Default Title"
                        ...
                        : (optionElement.html(variantTitle), optionElement.attr("value", variant.id), optionElement.attr("data-flits-variant-price", variantPrice)),
                        Flits.ajax({ type: "GET", url: location.origin + "/products/" + product.handle + "?view=flits_product_variant_data&variant=" + variant.id })
                                ...
                                if (!response.variant_available) {
                                    ...
                                    if (selectedText.indexOf(Flits.t("Flits.locals.buttons.sold_out", "Sold Out")) != -1) {
                                        ...
                                        Flits(itemDom).find(".flits-add-to-cart").addClass("flits-btn-danger"),
                                            Flits(itemDom).find(".flits-add-to-cart").attr("disabled", !0),
                                            Flits(itemDom).find(".flits-add-to-cart").text(sold_out_text),
                                            Flits(itemDom).find(".flits-product-quantity").addClass("flits-disabled");
                                    }
                                    product.variants.length == 1 && variantTitle == "Default Title" && Flits(itemDom).find(".flits-floating-label .flits-variant-select").html("");
                                }
                                response.variant_available && response.inventory_management == "shopify" && response.inventory_quantity > 0 && optionElement.attr("data-flits-inventory-quantity", response.inventory_quantity);
                            ...
                            .fail(function (resp) {})
                            .always(function () {}),
                        variantPriceValue <= 0 && (variantPriceValue = variantPrice),
                        Flits(itemDom).find(".flits-floating-label .flits-variant-select").append(optionElement),
            ...
            Flits.ajax({ type: "GET", url: "/products/" + handle + ".json" })
                .done(function (resp) {
                    fillProductData(resp), Flits.dispatchEvent("Flits:getShopifyProductData:complete", { handle: handle, resp: resp, item: item, status: !0 });
                })
                .fail(function (resp) {
                    Flits.dispatchEvent("Flits:getShopifyProductData:complete", { handle: handle, resp: resp, item: item, status: !1 });
                })
                .always(function () {});
        },
        variantOnChange: function (evt) {
            ...
            selectedVariantText.indexOf(Flits.t("Flits.locals.buttons.sold_out", "Sold Out")) != -1
                ? ((addCartBtnText = addCartBtn.attr("data-flits-sold-text")), addCartBtn.attr("disabled", !0), addCartBtn.addClass("flits-btn-danger"), quantityBtn.addClass("flits-disabled"))
                : ((addCartBtnText = addCartBtn.attr("data-flits-add-cart-text")), addCartBtn.attr("disabled", !1), addCartBtn.removeClass("flits-btn-danger"), quantityBtn.removeClass("flits-disabled")),
        ...
        productQuntityAdjust: function (evt) {
            ...
            if (Flits(el).attr("data-flits-qty-btn") == "plus")
                if (maxLimit)
                    if (maxLimit > qty) qty += 1;
                    else {
                        let errorMsg = Flits.t("Flits.locals.general.cant_add_more_quantity", "You can't add more than {{ quantity }} quantity");
                        (errorMsg = errorMsg.replace("{{ quantity }}", qty)), flitsSnackbar.show({ text: errorMsg, pos: "bottom-center", showAction: !1, customClass: "flits-alert-error" });
                    }
                else qty += 1;
            else qty = qty <= qtyMin ? qtyMin : qty - 1;
            quantitySelector.val(qty);
        },
        addToCart: function (params) {
            flitsSnackbar.show({ text: Flits.t("Flits.locals.cart_page.adding_items_to_cart", "Adding items to cart..."), pos: "bottom-center", showAction: !1, customClass: "flits-alert-default", duration: !1 }),
                Flits.ajax({ type: "POST", url: "/cart/add.js", data: params, dataType: "json" })
                    .done(function (resp) {
                        Flits.flitsSnackbarHide(), (location.href = "/cart");
                    })
                    .fail(function (resp) {
                        flitsSnackbar.show({ text: resp.responseJSON.description, pos: "bottom-center", showAction: !1, customClass: "flits-alert-error" });
                    })
                    .always(function () {});
        },
        ...
        setupContainer: function () {
            if ((Flits(".flits-account-page-nav").css("height", "auto"), Flits(".flits-tabs-box").parent().css("height", "auto"), Flits(".flits-tabs-box").css("min-height", "auto"), Flits(window).width() < 992))
                Flits(".flits-account-page-nav").css("height", "auto"), Flits(".flits-tabs-box").parent().css("height", "auto"), Flits(".flits-tabs-box").css("height", "auto"), Flits(".flits-tabs-box").css("min-height", "auto");
            else {
                var height = 0;
                ...
                Flits(".flits-account-page-nav").css("height", height), Flits(".flits-tabs-box").parent().css("height", height), Flits(".flits-tabs-box").css("min-height", height);
            }
        },
        ...
        validatePhone: function (data) {
            return new libphonenumber.parsePhoneNumber(data).isValid() ? !0 : !1;
        },
        isNumber: function (evt) {
            evt = evt ? evt : window.event;
            var charCode = evt.which ? evt.which : evt.keyCode;
            return charCode > 31 && (charCode < 48 || charCode > 57) ? !1 : !0;
        },
        validateEmail: function (data) {
            let testData = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;
            return testData.test(data) ? !0 : !1;
        },
        ...
        watchForHover: function () {
            function enableHover() {
                ...
                Flits(container).addClass(hoverClass), (hasHoverClass = !0);
            }
            function disableHover() {
                if (!hasHoverClass) return;
                Flits(container).removeClass(hoverClass), (hasHoverClass = !1);
            }
            ...
            Flits(document).on("touchstart", function () {
                updateLastTouchTime(), disableHover();
            }),
        ...
        paginationDisabled: function (list, selector) {
            ...
            Flits(selector + " .flits-prev-btn[disabled], " + selector + " .flits-next-btn[disabled]").attr("disabled", !1),
                isFirst && Flits(selector + " .flits-prev-btn").attr("disabled", !0),
                isLast && Flits(selector + " .flits-next-btn").attr("disabled", !0),
                list.matchingItems.length <= list.page ? Flits(selector).addClass("flits-d-none") : Flits(selector).removeClass("flits-d-none");
        },
        ...
        flitsOldCode: function () {
            Flits(".flits-code-snippet")
                ...
                .load("/account?view=flits .flits-old-code-snippet", function () {
                    Flits(".flits-code-snippet").remove(), Flits(".flits-old-code-snippet").show();
                });
        },
        accountSettingAjax: function () {
            ...
            Flits.setTemplateColor(Flits.accountSettings.colorSettings),
                Flits.ajax({ method: "GET", header: header, url: url, data: params })
                    .done(function (resp) {
                        Flits.setLocalStorage("account_status", resp), Flits.setLocalStorage("account_status_update_at", new Date()), resp.status ? Flits.flitsNewCode() : Flits.flitsOldCode();
                    })
                    .fail(function (resp) {
                        Flits.setLocalStorage("account_status", resp.responseJSON), resp.status == 404 && Flits.flitsOldCode();
                    })
                    .always(function () {});
        },
        ...
        birthdayCountDown: function () {
            Flits.AccountPage.settings.bdayInterval && clearInterval(Flits.AccountPage.settings.bdayInterval);
            ...
            if (dob) {
                ...
                Flits.AccountPage.settings.bdayInterval = setInterval(function () {
                    ...
                    distance < 0 && ((birthday = currentYear + 1 + "-" + bMonth + "-" + bDay), (countDown = new Date(birthday).getTime()), (distance = countDown - now));
                    ...
                    (Flits.AccountPage.settings.dobCountDown = remainingDays),
                        !Flits.isNull(remainingDays) &&
                            Flits(".flits-birthday-rule-description").attr("data-flits-birthdate-count-text") &&
            ...
            (settings = Flits.extend(Flits.services.settings, settings, options)),
                (Flits.services.settings.customerSevices = function (callBack) {
                    Flits.ajax({ type: "GET", url: Flits.base_url + "/customer/get", contentType: "application/x-www-form-urlencoded", data: { customer_hash: Flits.customerHash, token:Flits.token, customer_id: Flits.customer_id } })
                        .done(function (resp) {
                            Flits.dispatchEvent("Flits:customer:AjaxSuccessful", { resp: resp }), callBack && callBack(resp);
                        })
                        .fail(function (resp) {
                            flitsSnackbar.show({ text: resp.statusText, pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" });
                        })
                ...
                (Flits.services.settings.wishlistService = function (callBack) {
                    Flits.ajax({ type: "GET", url: Flits.base_url + "/wishlist", data: { customer_id: Flits.customer_id, customer_hash: Flits.customerHash, token:Flits.token }, contentType: "application/x-www-form-urlencoded" })
                        .done(function (resp) {
                            Flits.dispatchEvent("Flits:Wishlist:AjaxSuccessful", { resp: resp }), callBack && callBack(resp);
                        })
                        .fail(function (resp) {
                            flitsSnackbar.show({ text: resp.statusText, pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" });
                        })
                ...
                (Flits.services.settings.topOrderService = function (callBack) {
                    Flits.ajax({ type: "GET", url: Flits.base_url + "/" + Flits.customer_id + "/top_product_from_all_order", contentType: "application/x-www-form-urlencoded", data: { customer_hash: Flits.customerHash, token:Flits.token } })
                        .done(function (resp) {
                            Flits.dispatchEvent("Flits:topOrder:AjaxSuccessful", { resp: resp }), callBack && callBack(resp);
                        })
                        .fail(function (resp) {
                            flitsSnackbar.show({ text: resp.statusText, pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" });
                        })
                ...
                (Flits.services.settings.rulesService = function (callBack) {
                    Flits.ajax({ type: "POST", url: Flits.base_url + "/" + Flits.customer_id + "/get_rule", data: { customer_hash: Flits.customerHash, token:Flits.token, theme_id: Flits.theme.id } })
                        .done(function (resp) {
                            Flits.dispatchEvent("Flits:rulesGet:AjaxSuccessful", { resp: resp }), Flits.dispatchEvent("Flits:howToEarnCredit:AjaxSuccessful", { resp: resp }), callBack && callBack(resp);
                        })
                        .fail(function (resp) {
                            flitsSnackbar.show({ text: resp.statusText, pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" });
                        })
                ...
                (Flits.services.settings.storeCreditService = function (callBack) {
                    Flits.ajax({ method: "GET", url: Flits.base_url + "/" + Flits.customer_id + "/credit/get_credit", data: { customer_hash: Flits.customerHash, token:Flits.token } })
                        .done(function (resp) {
                            Flits.dispatchEvent("Flits:storeCredit:AjaxSuccessful", { resp: resp }), callBack && callBack(resp);
                        })
                        .fail(function (resp) {
                            flitsSnackbar.show({ text: resp.statusText, pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" });
                        })
                ...
                (Flits.services.settings.referCreditService = function (callBack) {
                    Flits.ajax({ method: "GET", url: Flits.base_url + "/" + Flits.customer_id + "/refer_friend/get_referral_data", data: { customer_hash: Flits.customerHash, token:Flits.token } })
                        .done(function (resp) {
                            Flits.dispatchEvent("Flits:referCredit:AjaxSuccessful", { resp: resp }), callBack && callBack(resp);
                        })
                        .fail(function (resp) {
                            flitsSnackbar.show({ text: resp.statusText, pos: "bottom-center", showAction: !1, customClass: "flits-alert-danger" });
                        })
        ...
        navigationBind: function (options) {
            ...
            var settings = {
                navs: [
                    { title: Flits.t("Flits.locals.navigation.profile", "My Profile"), url: "#profile", target: 0, menuClass: null, badge: null, icon: caretIcon, isShow: 1, loader: { loader_class: null }, body_html: null },
                    {
                    ...
                    },
                    {
                        ...
                        icon: caretIcon,
//                         isShow: Flits.Metafields.IS_WISHLIST_PAID && Flits.Metafields.IS_WISHLIST_ENABLE, //we have comment this code because merchant has asking wishlist tab not show in account page.
	 					isShow: 0,
                        loader: { loader_class: null },
                        body_html: null,
                    },
                    ...
                    { title: Flits.t("Flits.locals.navigation.log_out", "Log Out"), url: "/account/logout", target: 0, menuClass: null, badge: null, icon: null, isShow: 1, loader: null, body_html: null },
                ],
                extraNavs: [],
            };
            settings = Flits.extend(!0, settings, options);
            ...
            if (extraPageCount)
                for (i = 1; i <= extraPageCount; i++) {
                    ...
                    } else (_url = Flits.Metafields["url_" + i]), (_target = 1);
                    ...
                    settings.navs.splice(9 + spliceIndex, 0, obj), spliceIndex++;
                }
            for (Flits.dispatchEvent("Flits:Navigation:Loaded", { settings: settings }), i = 0; i < settings.navs.length; i++) {
                if (settings.navs[i].isShow) {
                    ...
                    Flits(menuItemCloneNode).removeClass("flits-menu-item-template"),
                        settings.navs[i].menuClass && Flits(menuItemCloneNode).addClass(settings.navs[i].menuClass),
                        Flits(menuItemCloneNode).find(".flits-nav-link").attr("href", settings.navs[i].url),
                        settings.navs[i].target && Flits(menuItemCloneNode).find(".flits-nav-link").attr("target", "_blank"),
                        ...
                        settings.navs[i].badge && Flits(menuItemCloneNode).find(".flits-nav-link").append(settings.navs[i].badge),
                ...
                if (settings.navs[i].url.includes("#")) {
                    ...
                    if (Flits("#flits_tab_" + urlWithOutHash).length)
                        settings.navs[i].loader && (settings.navs[i].loader.loader_class && Flits(loaderClone).addClass(settings.navs[i].loader.loader_class), Flits("#flits_tab_" + urlWithOutHash).append(loaderClone)),
                            settings.navs[i].body_html && Flits("#flits_tab_" + urlWithOutHash).html(settings.navs[i].body_html);
                    else if (settings.navs[i].body_html) {
                        var bodyCardClone = Flits(".flits-body-card-template").clone();
                        Flits(bodyCardClone).removeClass("flits-body-card-template"),
                            ...
                            settings.navs[i].loader && (settings.navs[i].loader.loader_class && Flits(loaderClone).addClass(settings.navs[i].loader.loader_class), Flits(bodyCardClone).find(".flits-tab-box-body").append(loaderClone)),
                            Flits(bodyCardClone).find(".flits-tab-box-body").html(settings.navs[i].body_html),
                            Flits(".flits-account-page-container .flits-account-page-tabs .flits-tabs-box").append(bodyCardClone);
                    }
                }
            ...
            Flits(".flits-account-page-container .flits-skeleton-nav-tabs").fadeOut(0, function () {
                Flits(".flits-account-page-container .flits-account-page-nav .flits-nav-tabs").removeClass("flits-d-none"), Flits(".flits-account-page-container .flits-skeleton-nav-tabs").remove();
            });
        },
        extraPageBind: function () {
            ...
            for (i = 1; i <= extraPageCount; i++) {
                ...
                Flits.Metafields["type_" + i] == "PAGE" &&
                    Flits.get("/pages/" + url + ".json", function (resp) {
                        let title = resp.page.title;
                        let bodyHtml = resp.page.body_html;
                        bodyCardClone.find(".flits-tab-box-header .flits-tab-box-title").html(title), bodyCardClone.find(".flits-tab-box-body").html(bodyHtml), Flits("#flits_tab_" + url).html(bodyCardClone.html());
                    });
            }
        },
    }),
        ...
        (Flits.CountryProvinceSelector.prototype = {
            initCountry: function () {
                ...
                Flits.setSelectorByValue(this.countryEl, value), this.countryHandler();
            },
            initProvince: function () {
                const value = this.provinceEl.getAttribute("data-default");
                value && this.provinceEl.options.length > 0 && Flits.setSelectorByValue(this.provinceEl, value);
            },
            countryHandler: function (e) {
                ...
                this.clearOptions(this.provinceEl), provinces && provinces.length == 0 ? (this.provinceContainer.style.display = "none") : (this.setOptions(this.provinceEl, provinces), (this.provinceContainer.style.display = ""));
            },
            ...
            setOptions: function (selector, values) {
                for (let i = 0, count = values.length; i < values.length; i++) {
                    ...
                    (opt.value = values[i][0]), (opt.innerHTML = values[i][1]), selector.appendChild(opt);
                }
            },
        }),
        Flits.watchForHover();
    ...
    if (
            ...
            if (
                ...
                (instances &&
                    (instances.length
                        ...
                        : instances.destroy()),
                event.target.hasAttribute("data-tippy-content"))
            )
        ...
        if (lastUpdateAt != undefined || isNaN(lastUpdateAt)) {
            ...
            if (lastUpdateAtTime <= Flits.cacheTime) {
                ...
                respValue.status ? Flits.flitsNewCode() : Flits.flitsOldCode();
            } else Flits.accountSettingAjax();
        } else Flits.accountSettingAjax();
    } else Flits.accountSettingAjax();
})(Flits);
